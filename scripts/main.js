...
const CLEFAPI = '68997f92f86ab4b04f6c3c7adde7feac';
let resultatsAPI;
...
if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(position => {
       ...
       AppelAPI(long, lat);
        ...
        alert(`Vous avez refusé la géolocalisation, l'application ne puet pas fonctionner, veullez l'activer.`)
    } );
}
